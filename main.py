...
st.write("**Focus**: - Which services tend to have high churn? - What would we do to reduce churn? - What should be the strategy to employ to reduce churn in the future")
st.write("---")
